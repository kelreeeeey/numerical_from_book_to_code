...
from python_libs.area_within_interval import AreaWithinInterval
...
def example_area_within_interval() -> None:
    clib = AreaWithinInterval()
    clib.quadratic_summation(10, 10)
    return None

def main():
    problem_a()
    # example_area_within_interval()
